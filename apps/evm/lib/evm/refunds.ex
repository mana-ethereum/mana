defmodule EVM.Refunds do
  ...
  ## Examples
      ...
      iex> EVM.Refunds.refund(machine_state, exec_env)
      15000
  """
  @spec refund(MachineState.t(), ExecEnv.t()) :: t | nil
  def refund(machine_state, exec_env) do
    operation = MachineCode.current_operation(machine_state, exec_env)
    inputs = Operation.inputs(operation, machine_state)
    refund(operation.sym, inputs, machine_state, exec_env) || 0
  end

  def refund(:sstore, [key, new_value], _machine_state, exec_env) do
