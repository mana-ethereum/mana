defmodule EVM.Operation.StopAndArithmetic do
  ...
  def add([s0, s1], _), do: MathHelper.handle_overflow(s0 + s1)
  ...
  def mul([s0, s1], _), do: MathHelper.handle_overflow(s0 * s1)
  ...
  def sub([s0, s1], _), do: MathHelper.handle_overflow(s0 - s1)
