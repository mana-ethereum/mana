defmodule ExWire.Struct.Node do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ExWire.Struct.Node.new(<<4, 108, 224, 89, 48, 199, 42, 188, 99, 44, 88, 226, 228, 50, 79,
  ...
  ## Examples
      ...
      ...>       214, 6>>)
      iex> ExWire.Struct.Node.distance(node1, node2)
      131
  """
  ...
  ## Examples
      ...
      ...>         23, 184, 239, 149, 9, 14, 119, 179, 18, 213, 204, 57, 53, 79, 134, 213,
      ...>         214, 6>>)
      iex> ExWire.Struct.Node.common_prefix(node1, node2)
      0
  """
