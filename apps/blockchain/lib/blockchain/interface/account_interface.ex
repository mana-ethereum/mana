...
defimpl EVM.Interface.AccountInterface, for: Blockchain.Interface.AccountInterface do
  ...
  ## Examples
      ...
      ...> |> Blockchain.Interface.AccountInterface.new()
      ...> |> EVM.Interface.AccountInterface.create_contract(<<0x10::160>>, <<0x10::160>>, 1000, 1, 5, EVM.MachineCode.compile([:push1, 3, :push1, 5, :add, :push1, 0x00, :mstore, :push1, 32, :push1, 0, :return]), 5, %Block.Header{nonce: 1},  EVM.Configuration.FrontierTest.new())
      iex> account_interface.state.root_hash
