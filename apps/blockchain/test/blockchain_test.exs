defmodule BlockchainTest do
  ...
  @failing_tests %{
    ...
    "Constantinople" => [
      ...
      "GeneralStateTests/stCreate2/Create2Recursive_d0g1v0.json",
      "GeneralStateTests/stCreate2/CreateMessageRevertedOOGInInit_d0g0v0.json",
      "GeneralStateTests/stCreate2/CreateMessageRevertedOOGInInit_d0g1v0.json",
      "GeneralStateTests/stCreate2/CreateMessageReverted_d0g0v0.json",
      "GeneralStateTests/stCreate2/CreateMessageReverted_d0g1v0.json",
      ...
      "GeneralStateTests/stCreate2/RevertDepthCreateAddressCollision_d0g0v0.json",
      "GeneralStateTests/stCreate2/RevertDepthCreateAddressCollision_d0g0v1.json",
      "GeneralStateTests/stCreate2/RevertDepthCreateAddressCollision_d0g1v0.json",
      "GeneralStateTests/stCreate2/RevertDepthCreateAddressCollision_d0g1v1.json",
      "GeneralStateTests/stCreate2/RevertDepthCreateAddressCollision_d1g0v0.json",
      "GeneralStateTests/stCreate2/RevertDepthCreateAddressCollision_d1g0v1.json",
      "GeneralStateTests/stCreate2/RevertDepthCreateAddressCollision_d1g1v0.json",
      "GeneralStateTests/stCreate2/RevertDepthCreateAddressCollision_d1g1v1.json",
      "GeneralStateTests/stCreate2/RevertInCreateInInit_d0g0v0.json",
      "GeneralStateTests/stCreate2/RevertOpcodeCreate_d0g0v0.json",
      "GeneralStateTests/stCreate2/RevertOpcodeCreate_d0g1v0.json",
