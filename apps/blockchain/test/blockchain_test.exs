defmodule BlockchainTest do
  ...
  @failing_tests %{
    ...
    "Homestead" => [
      ...
      "GeneralStateTests/stCodeCopyTest/ExtCodeCopyTests_d0g0v0.json",
      ...
      "GeneralStateTests/stRandom/randomStatetest367_d0g0v0.json",
      "GeneralStateTests/stRandom2/randomStatetest545_d0g0v0.json",
