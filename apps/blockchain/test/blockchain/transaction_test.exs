  ...
  describe "valid?/3" do
    test "invalidates transaction when sender address is nil" do
      ...
      result =
        ...
        |> Blockchain.Transaction.valid?(trx, %Block.Header{})
    ...
    test "invalidates account when tranaction gas limit exceeds header gas limit" do
      ...
      result =
        ...
        |> Blockchain.Transaction.valid?(trx, %Block.Header{gas_limit: 50_000, gas_used: 49_999})
    ...
    test "validates account" do
      ...
      result =
        ...
        |> MerklePatriciaTree.Trie.new()
        |> Blockchain.Account.put_account(sender, %Blockchain.Account{balance: 100_006, nonce: 5})
        |> Blockchain.Transaction.valid?(trx, %Block.Header{gas_limit: 500_000, gas_used: 49_999})
