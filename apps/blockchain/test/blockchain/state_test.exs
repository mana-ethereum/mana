defmodule Blockchain.StateTest do
  ...
  @failing_tests %{
    "EIP150" => [
      ...
      "stSystemOperationsTest/createWithInvalidOpcode",
      ...
      "stMemExpandingEIP150Calls/ExecuteCallThatAskMoreGasThenTransactionHasWithMemExpandingCalls",
      "stMemExpandingEIP150Calls/DelegateCallOnEIPWithMemExpandingCalls",
      ...
      "stMemExpandingEIP150Calls/CallAndCallcodeConsumeMoreGasThenTransactionHasWithMemExpandingCalls",
      ...
      "stEIP150Specific/Transaction64Rule_d64p1",
      "stEIP150Specific/Transaction64Rule_d64m1",
      "stEIP150Specific/Transaction64Rule_d64e0",
      "stEIP150Specific/SuicideToNotExistingContract",
      "stEIP150Specific/ExecuteCallThatAskForeGasThenTrabsactionHas",
      "stEIP150Specific/DelegateCallOnEIP",
      "stEIP150Specific/CreateAndGasInsideCreate",
      "stEIP150Specific/CallAskMoreGasOnDepth2ThenTransactionHas",
      "stEIP150Specific/CallAndCallcodeConsumeMoreGasThenTransactionHas",
      "stDelegatecallTestHomestead/delegatecodeDynamicCode",
      "stDelegatecallTestHomestead/delegatecallInInitcodeToExistingContractOOG",
      "stDelegatecallTestHomestead/delegatecallAndOOGatTxLevel",
      ...
      "stChangedEIP150/callcall_00_OOGE_valueTransfer",
      "stChangedEIP150/callcall_00_OOGE_2",
      "stChangedEIP150/callcall_00_OOGE_1",
      "stChangedEIP150/Callcode1024BalanceTooLow",
      "stChangedEIP150/Call1024PreCalls",
      "stChangedEIP150/Call1024BalanceTooLow"
    ],
    "Frontier" => [
      "stTransactionTest/UserTransactionGasLimitIsTooLowWhenZeroCost",
      "stTransactionTest/TransactionToItselfNotEnoughFounds",
