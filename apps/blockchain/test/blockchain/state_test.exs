defmodule Blockchain.StateTest do
  ...
  @failing_tests %{
    "Byzantium" => [
      ...
      "stStaticCall/static_callcodecallcallcode_101_OOGMAfter_3",
      "stStaticCall/static_callcodecallcallcode_101_OOGMAfter_1",
      "stStaticCall/static_callcallcodecallcode_011_SuicideMiddle2",
      ...
      "stStaticCall/static_callcallcodecall_010_SuicideMiddle",
      "stStaticCall/static_callcallcodecall_010_SuicideEnd2",
      "stStaticCall/static_callcallcodecall_010_SuicideEnd",
      "stStaticCall/static_callcallcodecall_010_OOGMBefore2",
      "stStaticCall/static_callcallcodecall_010_OOGMBefore",
      "stStaticCall/static_callcallcodecall_010_OOGE",
      "stStaticCall/static_callcallcallcode_001",
      "stStaticCall/static_callWithHighValueAndOOGatTxLevel",
      "stStaticCall/static_callCreate",
      "stStaticCall/static_callBasic",
      "stStaticCall/static_RevertOpcodeCalls",
      "stStaticCall/static_PostToReturn1",
      "stStaticCall/static_CallSha256_1_nonzeroValue",
      "stStaticCall/static_CallIdentity_1_nonzeroValue",
