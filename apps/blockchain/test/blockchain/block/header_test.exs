defmodule Blockchain.Block.HeaderTest do
  use ExUnit.Case, async: true
  doctest Blockchain.Block.Header
  ...
  test "serialize and deserialize" do
    ...
    assert header == header |> Header.serialize |> ExRLP.encode |> ExRLP.decode |> Header.deserialize
  end
