defmodule ExthCrypto.KDF.NistSp80056 do
  ...
  """
  @spec single_step_kdf(binary(), integer(), ExthCrypto.Hash.hash_type, binary()) :: {:ok, binary()} | {:error, String.t}
    ...
    cond do
      ...
      true ->
        derived_keying_material_padded = Enum.reduce(1..reps, <<>>, fn counter, results ->
          counter_enc = :binary.encode_unsigned(counter |> mod(@two_power_32), :big) |> ExthCrypto.Math.pad(4)
